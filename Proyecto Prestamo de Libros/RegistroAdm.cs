...
namespace Proyecto_Prestamo_de_Libros
{
    public partial class RegistroAdm : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            string sql;
            con.Open();
            sql = "INSERT INTO RegistroAdm(Nombre, Apellido, Edad, Sexo, Telefono, Contraseña) VALUES(@Nombre, @Apellido, @Edad, @Sexo, @Telefono, @Contraseña)";
            ...
            MessageBox.Show("Registrado Administrador");
            con.Close();
            this.Hide();
